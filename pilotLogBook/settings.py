# Django settings for pilotLogBook project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'pilotLogBook.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'v$$8n(6retqn=th421=9ntl-_593xyvx%%eoq=874l)o-#s%^u'
